 ...
 * @LastEditTime: 2021-11-09 11:13:47
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \uni-demo\src\components\my\my-team-card.vue
-->
<template>
	 ...
	 @longtap="longTap">
		<view class="tui-card-header" :class="{'tui-header-line':header.line}" :style="{background:header.bgcolor || '#fff'}">
			<view class="tui-header-left">
                ...
                <!-- <tui-rate class="tui-rate" :current="3" hollow="true" disabled="true" style="width: 160px;"></tui-rate> -->
                <view class="tui-rate-container">
                    <tui-rate :current="rate" hollow="true" disabled="true"></tui-rate>
                </view>
			</view>
